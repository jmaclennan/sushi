...
export const MenuItemTableRow: React.FC<MenuItemProps> = ({
  id,
  name,
  description,
  price,
  ...
  return (
    <tr
      className="hover:bg-neutral-100/50 group border-solid border-b border-neutral-300 border-b-1 cursor-pointer bg-red-500"
      onClick={handleClick}
    >
      <td className="w-3/5 py-4 md:py-2 pl-2">
      ...
      <td className="w-1/5 text-center">{formatPrice(price)}</td>
      <td className="w-1/5 text-center">
        {!!altPrice && formatPrice(altPrice)}
      </td>
    </tr>
  );
};
